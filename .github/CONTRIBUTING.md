...
- [Search our issue
  tracker](https://github.com/manifoldco/sowhatsnew/issues/search&type=issues)
...
`sowhatsnew`, commit your changes, and [open a pull
...
Manifold's sowhatsnew is released under the [BSD 3-Clause
License](../LICENSE.md).
...
agreement](https://cla-assistant.io/manifoldco/sowhatsnew), either for an
